...
const List<_GameSpec> _games = [
  _GameSpec(0, 'Notes', 'Find & identify notes on the neck',
      Icons.music_note_rounded, Color(0xFF34C6A5), [
    ('find', 'Find'),
    ('identify', 'Identify'),
  ]),
  _GameSpec(1, 'Intervals', 'Name & build every interval',
      Icons.straighten_rounded, Color(0xFFFE5D43), [
    ('name', 'Name'),
    ('build', 'Build'),
  ]),
  _GameSpec(2, 'Chords', 'Name & build chord shapes',
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Pick a game to see your strong and weak spots',
